...
class OrcamentoTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.url_de_orcamento_detalhada = reverse('Orcamento-detail', args=[self.orcamento.id])
    ...
    def test_requisicao_put_para_atualizar_orcamento(self):
        ...
        self.assertEqual(orcamento_atualizado.descricao, "Orçamento de Teste usado para realização de testes da API, atualização de Orçamento")
        self.assertEqual(orcamento_atualizado.observacao, "Orçamento requer manutenção geral, teste PUT")
